        ...
        if ($result->num_rows > 0) {
            ...
            if (password_verify($senha, $senhaHash)) {
                ...
                if ($tipo_usuario === $tipoUsuarioBD) {
                    ...
                    // Redirecionar para a página admin (tanto para admin quanto para cliente neste arquivo)
...
<head>
    ...
    <title>Login Administrativo - Acesse sua conta</title>
    <style>
    ...
    <div class="container">
            ...
            <form method="POST">
                ...
                <div class="user-type-selector">
                    <div class="user-type-option">
                        <input type="radio" id="login_admin" name="tipo_usuario" value="administrador" checked>
        ...
        <div id="registerForm" class="form-section" style="display:none;">
            ...
            <form method="POST">
                ...
                <div class="user-type-selector">
                    <div class="user-type-option">
                        <input type="radio" id="register_admin" name="tipo_usuario" value="administrador" checked>
                        <label for="register_admin" class="user-type-label">
                            <span class="user-type-icon">⚙️</span>
                            Administrador
                        </label>
                    </div>
